...
const DEFAULT_COMPONENT_SNAP_DISTANCE_PX = 3;
const DEFAULT_COMPONENT_MIN_SEGMENT_LENGTH_PX = 4;
const DEFAULT_SOLDER_JOINT_SNAP_DISTANCE_PX = 3;
const DEFAULT_SOLDER_JOINT_MIN_SEGMENT_LENGTH_PX = 4;
