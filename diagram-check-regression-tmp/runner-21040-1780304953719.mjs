    ...
    simulation: {
      ...
      issues: {
        ...
        wireAmpacityFullLoadRequired: {
          ...
          description: "Wire ampacity can only be evaluated reliably after a simulation at 100% brightness with {{mode}}. Run the simulation with those LED settings to check wire current limits."
        },
    ...
    simulation: {
      ...
      issues: {
        ...
        wireAmpacityFullLoadRequired: {
          ...
          description: "Die Strombelastbarkeit der Leitungen kann nur nach einer Simulation mit 100% Helligkeit und {{mode}} zuverlaessig bewertet werden. Fuehre die Simulation mit diesen LED-Einstellungen aus, um die Leitungs-Stromgrenzen zu pruefen."
        },
        ledStripSupplyVoltageLow: {
  ...
  sidebar: {
    ...
    simulation: {
      ...
      issues: {
        ...
        wireAmpacityFullLoadRequired: {
          title: "\u5BFC\u7EBF\u8F7D\u6D41\u80FD\u529B\u9700\u8981\u6EE1\u8F7D\u6A21\u62DF",
          description: "\u53EA\u6709\u5728 100% \u4EAE\u5EA6\u5E76\u4F7F\u7528 {{mode}} \u8FDB\u884C\u6A21\u62DF\u540E\uFF0C\u624D\u80FD\u53EF\u9760\u8BC4\u4F30\u5BFC\u7EBF\u8F7D\u6D41\u80FD\u529B\u3002\u8BF7\u4F7F\u7528\u8FD9\u4E9B LED \u8BBE\u7F6E\u91CD\u65B0\u8FD0\u884C\u6A21\u62DF\uFF0C\u4EE5\u68C0\u67E5\u5BFC\u7EBF\u7535\u6D41\u9650\u5236\u3002"
        },
        ledStripSupplyVoltageLow: {
          title: "LED \u706F\u5E26\u4F9B\u7535\u7535\u538B\u8FC7\u4F4E",
...
var wireAmpacityA = (crosssection, unit, installation = DEFAULT_WIRE_AMPACITY_SETTINGS.installation, ambientTempC = DEFAULT_WIRE_AMPACITY_SETTINGS.ambientTempC) => {
...
var formatAmp = (value) => String(Number(value.toFixed(2)));
